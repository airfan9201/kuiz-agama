...
QUIZ_DATA = {
    ...
    "sejarah": [
            ...
            {"id": 51, "soalan": "Siapakah bapa saudara Nabi SAW yang memelihara Baginda selepas kematian datuknya?", "pilihan": ["Abu Lahab", "Hamzah", "Abu Talib", "Abbas"], "jawapan": 2},
            {"id": 52, "soalan": "Apakah nama unta milik Nabi Muhammad SAW yang dinaiki semasa peristiwa Hijrah?", "pilihan": ["Al-Qaswa'", "Al-Buraq", "Al-Adba'", "Al-Wajihah"], "jawapan": 0},
            {"id": 53, "soalan": "Siapakah sahabat yang menggantikan tempat tidur Nabi SAW semasa rumah Baginda dikepung kafir Quraisy?", "pilihan": ["Abu Bakar As-Siddiq", "Ali bin Abi Talib", "Zaid bin Harithah", "Umar bin Al-Khattab"], "jawapan": 1},
            {"id": 54, "soalan": "Sahabat manakah yang dilantik oleh Nabi SAW sebagai gabenor dan da'i pertama di Madinah?", "pilihan": ["Mus'ab bin Umair", "Sa'ad bin Mu'adz", "Mu'adz bin Jabal", "Abu Ubaidah Al-Jarrah"], "jawapan": 0},
            {"id": 55, "soalan": "Apakah nama bandar asal tempat Hijrah sebelum ditukar nama kepada Madinatul Munawwarah?", "pilihan": ["Taif", "Khaibar", "Yathrib", "Syam"], "jawapan": 2},
            {"id": 56, "soalan": "Siapakah nama sahabat yang dipanggil 'Penterjemah Al-Quran' dan sepupu Nabi SAW?", "pilihan": ["Abdullah bin Mas'ud", "Abdullah bin Umar", "Abdullah bin Abbas", "Abdullah bin Salam"], "jawapan": 2},
            {"id": 57, "soalan": "Dalam peristiwa perang apakah para pemanah melanggar arahan Nabi SAW untuk tidak meninggalkan bukit?", "pilihan": ["Perang Badar", "Perang Uhud", "Perang Khandaq", "Perang Hunain"], "jawapan": 1},
            {"id": 58, "soalan": "Berapakah bilangan tentera Islam di dalam Perang Badar?", "pilihan": ["1000 Orang", "313 Orang", "700 Orang", "3000 Orang"], "jawapan": 1},
            {"id": 59, "soalan": "Siapakah nama isteri Nabi SAW yang dikenali dengan gelaran 'Ummu al-Masakin' (Ibu orang-orang miskin)?", "pilihan": ["Zainab binti Khuzaimah", "Juwayriyah binti al-Harith", "Safiyyah binti Huyayy", "Maimunah binti al-Harith"], "jawapan": 0},
            {"id": 60, "soalan": "Apakah nama kota benteng pertahanan kaum Yahudi yang ditakluki oleh tentera Islam di bawah pimpinan Ali bin Abi Talib?", "pilihan": ["Tabuk", "Khaibar", "Mut'ah", "Taif"], "jawapan": 1},
            {"id": 61, "soalan": "Siapakah sahabat yang mengetuai hijrah pertama umat Islam ke negeri Habsyah (Abyssinia)?", "pilihan": ["Ja'far bin Abi Talib", "Uthman bin Affan", "Zubair bin Al-Awwam", "Sa'ad bin Abi Waqqas"], "jawapan": 0},
            {"id": 62, "soalan": "Apakah nama surah Al-Quran yang diturunkan khusus menceritakan tentang peristiwa pembukaan kota Makkah?", "pilihan": ["Surah Al-Fath", "Surah An-Nasr", "Surah Al-Kafirun", "Surah Al-Quraish"], "jawapan": 1},
            {"id": 63, "soalan": "Siapakah nama bapa kepada Khadijah R.A?", "pilihan": ["Khuwailid bin Asad", "Nawfal bin Asad", "Waraqah bin Nawfal", "Abdul Uzza"], "jawapan": 0},
            {"id": 64, "soalan": "Berapakah tempoh masa pemulauan (pemboikotan) kaum Musyrikin Quraisy ke atas Bani Hashim dan Bani Muttalib?", "pilihan": ["1 Tahun", "5 Tahun", "3 Tahun", "2 Tahun"], "jawapan": 2},
            {"id": 65, "soalan": "Apakah nama masjid pertama yang dibina di Madinah di mana Kiblatnya ditukar dari Baitulmaqdis ke Kaabah?", "pilihan": ["Masjid Quba'", "Masjid Qiblatain", "Masjid Nabawi", "Masjid Al-Ghamamah"], "jawapan": 1},
            {"id": 66, "soalan": "Siapakah rahib Nasrani yang mengenal pasti tanda-tanda kenabian pada Nabi SAW semasa Baginda berumur 12 tahun?", "pilihan": ["Waraqah bin Nawfal", "Bahira", "Salman Al-Farisi", "Najasyi"], "jawapan": 1},
            {"id": 67, "soalan": "Berapakah bilangan tentera musyrikin Quraisy di dalam Perang Badar?", "pilihan": ["1000 Orang", "3000 Orang", "500 Orang", "10000 Orang"], "jawapan": 0},
            {"id": 68, "soalan": "Apakah nama perhimpunan/ikrar keadilan yang disertai oleh Nabi SAW semasa zaman remaja untuk membela orang yang teraniaya di Makkah?", "pilihan": ["Hilf al-Fudul", "Bay'at al-Aqabah", "Hilf al-Ahlaf", "Dar al-Nadwah"], "jawapan": 0},
            {"id": 69, "soalan": "Siapakah sahabat yang mencadangkan pengumpulan Al-Quran dalam satu mushaf pada zaman Khalifah Abu Bakar?", "pilihan": ["Zaid bin Thabit", "Umar bin Al-Khattab", "Uthman bin Affan", "Ali bin Abi Talib"], "jawapan": 1},
            {"id": 70, "soalan": "Di manakah tempat berkumpulnya pemuka Quraisy untuk merancang pembunuhan Nabi SAW sebelum peristiwa Hijrah?", "pilihan": ["Dar al-Arqam", "Dar al-Nadwah", "Gua Hira'", "Ma'la"], "jawapan": 1}            
        ],
    "solat_fardu": [
